...
import testPages.LogoutUser;
import utils.ExcelReader;

public class LogoutTestCase {

	BaseClass base = new BaseClass();
	LogoutUser logutUser = new LogoutUser();
...
//	}
	...
	@Test(priority = 2, dataProvider = "logut")
	...
	{
		logutUser.AccountInformationsFunctions(password, date, month, year, firstName, lastName, address1, country,
				state, city, zipcode, mobNumber);

	}

	@DataProvider(name = "logut")
	public Object[][] getAccountInfo() throws EncryptedDocumentException, IOException {

		return ExcelReader.excelDatas("logoutuser");
